...
## v2.17.10 — adição de artes e carregamento do filme (em implementação)
...
- Preservar remoção sem reorganizar, medidas, rotação, travas, rascunhos, conta/RLS, PNG original e TIFF CMYK + Spot. Nenhuma alteração de banco ou envio de artes a terceiros. Testar antes de declarar concluído; publicação online continua não confirmada.
