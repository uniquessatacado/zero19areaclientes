...
replaceOnce("    void refreshFilmJobs(media);filmDraftBanner();if(filmDraftDirty)saveFilmDraft();return true;","    mountFilmTools(media);void refreshFilmJobs(media);filmDraftBanner();if(filmDraftDirty)saveFilmDraft();return true;");
...
for(const name of ['app.js','production-v217.js','lettering-layout-v2176.js','film-saved-drafts.js','film-preview.js','customization-preparer.js','nesting-core.js','film-edit-core.js','film-tiff-core.js','film-cmyk-converter.js','film-spot-export.js','film-spot-worker.js','network-read.js','asset-preview.js','asset-studio-actions.js','art-studio.js','official-order-workflow.js'])execFileSync(process.execPath,['--check',name],{cwd:temp,stdio:'inherit'});
