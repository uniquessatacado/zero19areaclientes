...
replaceOnce("    void refreshOrders();void refreshFilmJobs(media);filmDraftBanner();if(filmDraftDirty)saveFilmDraft();return true;","    mountFilmTools(media);void refreshOrders();void refreshFilmJobs(media);filmDraftBanner();if(filmDraftDirty)saveFilmDraft();return true;");
