...
replaceOnce("    void refreshFilmJobs(media);void refreshOrders();filmDraftBanner();if(filmDraftDirty)saveFilmDraft();return true;","    mountFilmTools(media);void refreshFilmJobs(media);void refreshOrders();filmDraftBanner();if(filmDraftDirty)saveFilmDraft();return true;");
